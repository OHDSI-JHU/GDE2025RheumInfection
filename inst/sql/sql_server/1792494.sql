...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1705674,21602929,1751310,1730370,997881,1551099,1506270,1711759,1781733)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1705674,21602929,1751310,1730370,997881,1551099,1506270,1711759,1781733)
  and c.invalid_reason is null
