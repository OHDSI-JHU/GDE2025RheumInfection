...
tcis <- list(
  # ---------------- SLE (1794240) ----------------
  list(targetId = 1794247, comparatorId = 1794245, indicationId = 1794240, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_RTX),
  list(targetId = 1794247, comparatorId = 1794244, indicationId = 1794240, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_MMF),
  list(targetId = 1794247, comparatorId = 1794243, indicationId = 1794240, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_IVIG),
  list(targetId = 1794245, comparatorId = 1794244, indicationId = 1794240, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_MMF),
  list(targetId = 1794245, comparatorId = 1794243, indicationId = 1794240, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_IVIG),
  list(targetId = 1794244, comparatorId = 1794243, indicationId = 1794240, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_MMF_IVIG),

  # ---------------- Uveitis (1794239) ----------------
  list(targetId = 1794247, comparatorId = 1794245, indicationId = 1794239, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_RTX),
  list(targetId = 1794247, comparatorId = 1794244, indicationId = 1794239, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_MMF),
  list(targetId = 1794247, comparatorId = 1794243, indicationId = 1794239, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_IVIG),
  list(targetId = 1794245, comparatorId = 1794244, indicationId = 1794239, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_MMF),
  list(targetId = 1794245, comparatorId = 1794243, indicationId = 1794239, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_IVIG),
  list(targetId = 1794244, comparatorId = 1794243, indicationId = 1794239, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_MMF_IVIG),

  # ---------------- SSc (1794241) ----------------
  list(targetId = 1794247, comparatorId = 1794245, indicationId = 1794241, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_RTX),
  list(targetId = 1794247, comparatorId = 1794244, indicationId = 1794241, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_MMF),
  list(targetId = 1794247, comparatorId = 1794243, indicationId = 1794241, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_IVIG),
  list(targetId = 1794245, comparatorId = 1794244, indicationId = 1794241, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_MMF),
  list(targetId = 1794245, comparatorId = 1794243, indicationId = 1794241, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_IVIG),
  list(targetId = 1794244, comparatorId = 1794243, indicationId = 1794241, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_MMF_IVIG),

  # ---------------- DM (1794242) ----------------
  list(targetId = 1794247, comparatorId = 1794245, indicationId = 1794242, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_RTX),
  list(targetId = 1794247, comparatorId = 1794244, indicationId = 1794242, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_MMF),
  list(targetId = 1794247, comparatorId = 1794243, indicationId = 1794242, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_RTX_IVIG),
  list(targetId = 1794245, comparatorId = 1794244, indicationId = 1794242, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_MMF),
  list(targetId = 1794245, comparatorId = 1794243, indicationId = 1794242, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_JAKi_IVIG),
  list(targetId = 1794244, comparatorId = 1794243, indicationId = 1794242, genderConceptIds = c(8507, 8532), minAge = NULL, maxAge = NULL, excludedCovariateConceptIds = excludedCovariates_MMF_IVIG)
)
...
# Create time at risk settings separately
...
characterizationModuleSpecifications <- cModuleSettingsCreator$createModuleSpecifications(
  ...
  timeAtRisk = timeAtRiskSettings  # Pass as a single object
)
...
ParallelLogger::saveSettingsToJson(
  ...
  file.path("inst", "CDStudyAnalysisSpecification.json")
)
